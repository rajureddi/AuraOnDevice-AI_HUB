package com.aura_on_device_ai.mnnllm.api.openai.manager
...
import com.aura_on_device_ai.mnnllm.api.openai.service.ApiServerConfig
...
class ApiNotificationManager(private val context: Context) {
    ...
    private fun initializeNotificationChannel() {
        val channelName = context.getString(com.aura_on_device_ai.mnnllm.android.R.string.api_service_channel_name)
    ...
    fun buildNotification(
        ...
        val title = contentTitle ?: context.getString(com.aura_on_device_ai.mnnllm.android.R.string.api_service_running)
        val ipAddress = ApiServerConfig.getIpAddress(context)
        val url = "http://$ipAddress:$port"
        val text = if (contentText.isNullOrBlank()) {
            context.getString(com.aura_on_device_ai.mnnllm.android.R.string.api_service_running_on, ipAddress, port)
        } else {
            contentText
        }
        ...
        val mainActivityIntent = Intent(context, com.aura_on_device_ai.mnnllm.android.main.MainActivity::class.java).apply {
        ...
        val notification = NotificationCompat.Builder(context, CHANNEL_ID)
            ...
            //     context.getString(com.aura_on_device_ai.R.string.api_service_stop),
            //     stopPendingIntent
            // )
            .addAction(
                R.drawable.ic_dialog_info,
                context.getString(com.aura_on_device_ai.mnnllm.android.R.string.api_service_copy_url),
                copyPendingIntent
            )
            .addAction(
                R.drawable.ic_dialog_info,
                context.getString(com.aura_on_device_ai.mnnllm.android.R.string.api_service_test_page),
                testPendingIntent
            )
            .build()
