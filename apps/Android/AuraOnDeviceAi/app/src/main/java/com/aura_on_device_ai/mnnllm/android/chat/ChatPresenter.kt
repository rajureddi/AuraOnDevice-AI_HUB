...
class ChatPresenter(
     ...
     */
    fun getLlmSession(): com.aura_on_device_ai.mnnllm.android.llm.LlmSession? {
        return if (::chatSession.isInitialized && chatSession is com.aura_on_device_ai.mnnllm.android.llm.LlmSession) {
            chatSession as com.aura_on_device_ai.mnnllm.android.llm.LlmSession
        } else {
            null
        }
    }
    ...
    private fun applyChatHistoryToNewSession(newSession: ChatSession, currentChatHistory: List<ChatDataItem>) {
        if (newSession is com.aura_on_device_ai.mnnllm.android.llm.LlmSession && currentChatHistory.isNotEmpty()) {
