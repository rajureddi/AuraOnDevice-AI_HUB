...
import com.aura_on_device_ai.mnnllm.android.asr.AsrService
import com.aura_on_device_ai.mnnllm.android.audio.AudioChunksPlayer
import com.aura_on_device_ai.mnnllm.android.chat.ChatPresenter
import com.aura_on_device_ai.mnnllm.android.chat.GenerateResultProcessor
import com.aura_on_device_ai.mnnllm.android.utils.VoiceModelPathUtils
...
class VoiceChatPresenter(
    ...
    private fun speakGreetingMessage() {
        lifecycleScope.launch {
            try {
                ...
                val greetingMessage = activity.getString(com.aura_on_device_ai.mnnllm.android.R.string.voice_chat_ready_greeting)
    ...
    fun stop() {
        ...
        if (isProcessingLlm || isSpeaking) {
            ...
            if (activity is com.aura_on_device_ai.mnnllm.android.chat.ChatActivity) {
