...
class HfApiClient(val host: String) {
    ...
    // Get repo info
    fun getRepoInfoWithBlobs(repoId: String, revision: String = "main", blobs: Boolean = true): Call<HfRepoInfo> {
        return apiService.getRepoInfoInternal(repoId, revision, blobs)
    }
