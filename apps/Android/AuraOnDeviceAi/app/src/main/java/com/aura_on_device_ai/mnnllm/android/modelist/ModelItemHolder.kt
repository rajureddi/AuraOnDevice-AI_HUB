...
class ModelItemHolder(
    ...
    private fun updateButtonAndStatus(modelWrapper: ModelItemWrapper) {
        ...
        if (modelWrapper.hasUpdate) {
            ...
            tvStatus.text = if (formattedSize.isNotEmpty()) {
                context.getString(R.string.downloaded_click_to_chat, formattedSize)
            } else {
                context.getString(R.string.downloaded_click_to_chat, "")
            }
        }
    }
    ...
    override fun onClick(v: View) {
        ...
        // Removed: Automatic 'capture and explain' flow for visual models.
        // The user wants all models to open the chat section only.
        modelItemListener.onItemClicked(modelItem)
    }
    ...
    override fun onLongClick(v: View): Boolean {
        ...
        popupMenu.setOnMenuItemClickListener { item: MenuItem ->
            ...
            } else if (item.itemId == R.id.menu_remove_model) {
                modelItemListener.onItemRemoved(modelItem)
        ...
        // Delete, Remove and model info are always available
        popupMenu.menu.findItem(R.id.menu_delete_model).setVisible(isDeletable)
        popupMenu.menu.findItem(R.id.menu_remove_model).setVisible(true)
