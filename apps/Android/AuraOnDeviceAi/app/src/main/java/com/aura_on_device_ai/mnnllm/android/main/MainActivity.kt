...
package com.aura_on_device_ai.mnnllm.android.main
...
import com.aura_on_device_ai.mls.api.source.ModelSources
import com.aura_on_device_ai.mnnllm.android.R
import com.aura_on_device_ai.mnnllm.android.chat.ChatRouter
import com.aura_on_device_ai.mnnllm.android.chat.SelectSourceFragment
import com.aura_on_device_ai.mnnllm.android.mainsettings.MainSettings
import com.aura_on_device_ai.mnnllm.android.mainsettings.MainSettingsActivity
import com.aura_on_device_ai.mnnllm.android.modelmarket.ModelMarketFragment
import com.aura_on_device_ai.mnnllm.android.modelmarket.CommunityDownloadDialogFragment

import com.aura_on_device_ai.mnnllm.android.privacy.PrivacyPolicyDialogFragment
import com.aura_on_device_ai.mnnllm.android.privacy.PrivacyPolicyManager
import com.aura_on_device_ai.mnnllm.android.update.UpdateChecker
import com.aura_on_device_ai.mnnllm.android.utils.CrashUtil
import com.aura_on_device_ai.mnnllm.android.utils.GithubUtils
import com.aura_on_device_ai.mnnllm.android.utils.RouterUtils.startActivity
import com.aura_on_device_ai.mnnllm.android.utils.Searchable
import com.aura_on_device_ai.mnnllm.android.widgets.BottomTabBar
import com.aura_on_device_ai.mnnllm.android.widgets.ModelSwitcherView
...
class MainActivity : AppCompatActivity(), MainFragmentManager.FragmentLifecycleListener {
    ...
    private val menuProvider: MenuProvider = object : MenuProvider {
        ...
        override fun onPrepareMenu(menu: Menu) {
            ...
            val isHomeScreen = bottomNav.getSelectedTab() == BottomTabBar.Tab.AI_STUDIO
    ...
    override fun onTabChanged(newTab: BottomTabBar.Tab) {
        ...
        when (newTab) {
            BottomTabBar.Tab.CHAT -> {
                updateMainTitleSwitcherMode(false)
                mainTitleSwitcher.text = getString(R.string.local_models)
                appBarLayout.visibility = View.VISIBLE
                appBarLayout.setExpanded(true, false)
            }
            BottomTabBar.Tab.AI_STUDIO -> {
                updateMainTitleSwitcherMode(false)
                mainTitleSwitcher.text = getString(R.string.ai_studio)
                appBarLayout.visibility = View.VISIBLE
                appBarLayout.setExpanded(true, false)
            }
    ...
    companion object {
        ...
        const val EXTRA_SELECT_TAB = "com.aura_on_device_ai.mnnllm.android.select_tab"
