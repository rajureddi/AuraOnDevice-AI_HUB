...
package com.aura_on_device_ai.mnnllm.android.chat.chatlist
...
import com.aura_on_device_ai.mnnllm.android.chat.ChatActivity
import com.aura_on_device_ai.mnnllm.android.chat.PromptUtils
import com.aura_on_device_ai.mnnllm.android.chat.model.ChatDataItem
import com.aura_on_device_ai.mnnllm.android.chat.SelectTextActivity
import com.aura_on_device_ai.mnnllm.android.utils.ClipboardUtils
import com.aura_on_device_ai.mnnllm.android.utils.DeviceUtils
...
import com.aura_on_device_ai.mnnllm.android.utils.UiUtils
import com.aura_on_device_ai.mnnllm.android.widgets.FullScreenImageViewer
import com.aura_on_device_ai.mnnllm.android.widgets.PopupWindowHelper
...
object ChatViewHolders {
    ...
    class UserViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView), View.OnClickListener,
        ...
        val chatVideo: com.aura_on_device_ai.mnnllm.android.widgets.VideoPreviewView =
    ...
    class AssistantViewHolder @SuppressLint("ClickableViewAccessibility") constructor(view: View) :
        ...
        init {
            ...
            toggleBenchmarkButton.setOnClickListener {
                val chatActivity = itemView.context as? com.aura_on_device_ai.mnnllm.android.chat.ChatActivity
        ...
        private fun replayAudio(chatDataItem: ChatDataItem) {
            if (chatDataItem.hasOmniAudio && !chatDataItem.audioPath.isNullOrEmpty()) {
                ...
                val audioPlayService = com.aura_on_device_ai.mnnllm.android.utils.AudioPlayService.instance
                audioPlayService?.playAudio(chatDataItem.audioPath, object : com.aura_on_device_ai.mnnllm.android.utils.AudioPlayService.AudioPlayerCallback {
