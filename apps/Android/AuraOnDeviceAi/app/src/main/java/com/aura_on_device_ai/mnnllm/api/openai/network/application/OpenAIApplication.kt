package com.aura_on_device_ai.mnnllm.api.openai.network.application
...
import com.aura_on_device_ai.mnnllm.api.openai.manager.ServerEventManager
import com.aura_on_device_ai.mnnllm.api.openai.manager.ServerEventMonitor
import com.aura_on_device_ai.mnnllm.api.openai.network.logging.LogCollector
...
private fun Application.module(context: Context, host: String, port: Int) {
    ...
    //from com.aura_on_device_ai/mnnllm/api/openai/network/application/HTTP.kt
    configureHTTP(context)

    //from com.aura_on_device_ai/mnnllm/api/openai/network/application/Routing.kt
    configureRouting()
}
