...
object ModelRepository {
    ...
    private val context: Context by lazy { 
        com.aura_on_device_ai.mnnllm.android.MnnLlmApplication.getAppContext()
    }
    ...
    private fun isAllowNetwork(context: Context): Boolean {
        return com.aura_on_device_ai.mnnllm.android.utils.PreferenceUtils.getBoolean(context, KEY_ALLOW_NETWORK_MARKET_DATA, false)
    }
    
    private fun isNetworkDelayEnabled(context: Context): Boolean {
        return com.aura_on_device_ai.mnnllm.android.utils.PreferenceUtils.getBoolean(context, "debug_enable_network_delay", false)
    }
