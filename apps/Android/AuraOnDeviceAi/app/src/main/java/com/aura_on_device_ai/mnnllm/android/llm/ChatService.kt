...
class ChatService {
    ...
    fun createSession(
        ...
        } else if (ModelTypeUtils.isMediaPipeModel(modelId, configPath)) {
            MediaPipeChatSession(com.aura_on_device_ai.mls.api.ApplicationProvider.get(), modelId, sessionId, configPath!!, historyList)
        } else {
