...
import com.aura_on_device_ai.mnnllm.android.utils.UiUtils.getThemeColor
...
class VoiceRecordingModule(private val activity: ChatActivity) {
    ...
    fun updateModel(modelName: String) {
        ...
        val isAudioModel = com.aura_on_device_ai.mnnllm.android.model.ModelTypeUtils.isAudioModel(activity.modelId!!)
        updateVoiceButtonVisibility(isAudioModel)
