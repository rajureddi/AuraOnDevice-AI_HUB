...
import com.aura_on_device_ai.mnnllm.android.mainsettings.MainSettings.isStopDownloadOnChatEnabled
...
object ChatRouter {
    ...
    fun startCaptureAndExplain(context: Context, modelId: String, destModelDir: String?) {
        proceedToStartChatInternal(context, modelId, destModelDir, null, false, true)
    }

    private fun proceedToStartChat(context: Context, modelId: String, destModelDir: String?, sessionId: String?, isDiffusion: Boolean) {
        proceedToStartChatInternal(context, modelId, destModelDir, sessionId, isDiffusion, false)
    }

    private fun proceedToStartChatInternal(
        context: Context,
        modelId: String,
        destModelDir: String?,
        sessionId: String?,
