package com.aura_on_device_ai.mnnllm.api.openai.service

import android.content.Context
import com.aura_on_device_ai.mnnllm.api.openai.di.ServiceLocator
import com.aura_on_device_ai.mnnllm.api.openai.manager.ApiNotificationManager
import com.aura_on_device_ai.mnnllm.api.openai.network.application.OpenAIApplication
...
class ApiServiceCoordinator(private val context: Context) {
    ...
    fun startServer(): Boolean {
        ...
        return runCatching {
            ...
            val serverEventManager = com.aura_on_device_ai.mnnllm.api.openai.manager.ServerEventManager.getInstance()
            if (serverEventManager.getCurrentState() == com.aura_on_device_ai.mnnllm.api.openai.manager.ServerEventManager.ServerState.STOPPED) {
    ...
    fun stopServer() {
        runCatching {
            ...
            com.aura_on_device_ai.mnnllm.api.openai.manager.ServerEventManager.getInstance().resetRuntimeState()
