package com.aura_on_device_ai.mnnllm.android.service

import android.content.Context
import android.graphics.Bitmap
import android.util.Log
import com.aura_on_device_ai.mls.api.ModelItem
import com.aura_on_device_ai.mnnllm.android.chat.GenerateResultProcessor
import com.aura_on_device_ai.mnnllm.android.llm.ChatService
    ...
    suspend fun analyzeImageStream(
        ...
        try {
            ...
            if (isNavigation) {
                ...
                if (chatSession is com.aura_on_device_ai.mnnllm.android.llm.LlmSession) {
                    (chatSession as com.aura_on_device_ai.mnnllm.android.llm.LlmSession).updateMaxNewTokens(100)
                }
            } else {
                // Restore tokens for standard modes
                if (chatSession is com.aura_on_device_ai.mnnllm.android.llm.LlmSession) {
                    (chatSession as com.aura_on_device_ai.mnnllm.android.llm.LlmSession).updateMaxNewTokens(200)
                }
            }
