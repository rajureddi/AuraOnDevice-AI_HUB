...
import com.aura_on_device_ai.mnnllm.api.openai.service.OpenAIService
...
class ApiServiceActionReceiver : BroadcastReceiver() {
    ...
    companion object {
        const val ACTION_STOP_SERVICE = "com.aura_on_device_ai.mnnllm.api.openai.STOP_SERVICE"
        const val ACTION_COPY_URL = "com.aura_on_device_ai.mnnllm.api.openai.COPY_URL"
        const val ACTION_TEST_PAGE = "com.aura_on_device_ai.mnnllm.api.openai.TEST_PAGE"
    ...
    private fun copyUrlToClipboard(context: Context, url: String) {
        ...
        try {
            ...
            val successMessage = context.getString(com.aura_on_device_ai.mnnllm.android.R.string.api_url_copied)
