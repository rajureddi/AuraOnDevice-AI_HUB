package com.aura_on_device_ai.mnnllm.api.openai.network.logging
        ...
        private fun findCallerInfo(stackTrace: Array<StackTraceElement>): CallerInfo? {
            ...
            for (i in stackTrace.indices) {
                ...
                if (!className.startsWith("timber.log") &&
                    !className.startsWith("com.aura_on_device_ai.mnnllm.api.openai.network.logging") &&
                    !className.startsWith("java.lang") &&
                    !className.startsWith("android.") &&
                    className.contains("com.aura_on_device_ai.mnnllm")) {
