...
JNIEXPORT jlong JNICALL Java_com_aura_1on_1device_1ai_mnnllm_android_llm_LlmSession_initNative(JNIEnv *env,
                                                                                  jobject thiz,
                                                                                  jstring modelDir,
...
JNIEXPORT jobject JNICALL Java_com_aura_1on_1device_1ai_mnnllm_android_llm_LlmSession_submitNative(JNIEnv *env,
                                                                                      jobject thiz,
                                                                                      jlong llmPtr,
                                                                                      jstring inputStr,
...
// 新增：支持完整历史消息的JNI方法
JNIEXPORT jobject JNICALL Java_com_aura_1on_1device_1ai_mnnllm_android_llm_LlmSession_submitFullHistoryNative(
        JNIEnv *env,
        jobject thiz,
        jlong llmPtr,
...
Java_com_aura_1on_1device_1ai_mnnllm_android_llm_LlmSession_resetNative(JNIEnv *env, jobject thiz,
                                                           jlong object_ptr) {
...
Java_com_aura_1on_1device_1ai_mnnllm_android_llm_LlmSession_setWavformCallbackNative(
...
Java_com_aura_1on_1device_1ai_mnnllm_android_llm_LlmSession_getDebugInfoNative(JNIEnv *env, jobject thiz,
                                                                  jlong objecPtr) {
...
JNIEXPORT void JNICALL Java_com_aura_1on_1device_1ai_mnnllm_android_llm_LlmSession_releaseNative(JNIEnv *env,
                                                                                    jobject thiz,
                                                                                    jlong objecPtr) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_aura_1on_1device_1ai_mnnllm_android_llm_LlmSession_updateMaxNewTokensNative(JNIEnv *env, jobject thiz,
                                                                        jlong llm_ptr,
                                                                        jint max_new_tokens) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_aura_1on_1device_1ai_mnnllm_android_llm_LlmSession_updateSystemPromptNative(JNIEnv *env, jobject thiz,
                                                                        jlong llm_ptr,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_aura_1on_1device_1ai_mnnllm_android_llm_LlmSession_updateAssistantPromptNative(JNIEnv *env,
                                                                           jobject thiz,
                                                                           jlong llm_ptr,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_aura_1on_1device_1ai_mnnllm_android_llm_LlmSession_updateConfigNative(JNIEnv *env,
                                                                 jobject thiz,
                                                                 jlong llm_ptr,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_aura_1on_1device_1ai_mnnllm_android_llm_LlmSession_updateEnableAudioOutputNative(JNIEnv *env,jobject thiz, jlong llm_ptr, jboolean enable) {
    auto *llm = reinterpret_cast<mls::LlmSession *>(llm_ptr);
    if (llm) {
...
extern "C"
JNIEXPORT jstring JNICALL
Java_com_aura_1on_1device_1ai_mnnllm_android_llm_LlmSession_getSystemPromptNative(JNIEnv *env, jobject thiz,
                                                                     jlong llm_ptr) {
    auto *llm = reinterpret_cast<mls::LlmSession *>(llm_ptr);
    if (llm) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_aura_1on_1device_1ai_mnnllm_android_llm_LlmSession_clearHistoryNative(JNIEnv *env, jobject thiz,
                                                                  jlong llm_ptr) {
    auto *llm = reinterpret_cast<mls::LlmSession *>(llm_ptr);
    if (llm) {
        llm->clearHistory();
...
Java_com_aura_1on_1device_1ai_mnnllm_android_llm_LlmSession_runBenchmarkNative(
        JNIEnv *env,
        jobject thiz,
        jlong llmPtr,
        jint backend,
    ...
    if (!llm_session) {
        ...
        jclass resultClass = env->FindClass("com.aura_on_device_ai.mnnllm/android/benchmark/BenchmarkResult");
        jmethodID resultCtor = env->GetMethodID(resultClass, "<init>", 
            "(Lcom.aura_on_device_ai.mnnllm/android/benchmark/TestInstance;ZLjava/lang/String;)V");
    ...
    jmethodID onProgressMethod = env->GetMethodID(callbackClass, "onProgress", 
        "(Lcom.aura_on_device_ai.mnnllm/android/benchmark/BenchmarkProgress;)V");
    ...
    jclass progressClass = env->FindClass("com.aura_on_device_ai.mnnllm/android/benchmark/BenchmarkProgress");
